        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="row">
              ...
              <form method="post" action="{{url('shop_rekening/update')}}">
                @method('put')
                  @csrf
                <div class="card">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text" value="{{$data->nomor_rekening}}" name="nomor_rekening" class="form-control"/>
                      </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <select name="status" class="form-control">
                          ...
                          <option <?php if($data->status!="Aktif") echo "selected";?> value="Tidak Aktif">Tidak Aktif</option>
                        </select>
                      </div>
                  </div>
