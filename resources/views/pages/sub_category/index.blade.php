            ...
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  ...
                  <a href="{{url('/subCategory/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>&nbsp;
                    <h4>Data {{$pageName}}</h4>
                      ...
                      <table class="table table-bordered table-striped table-md data-table">
                        ...
                        @foreach($data as $d)
                            <tr>
                                ...
                                <td style="width:10%;">
                                    <form method="post" action="{{url('subCategory/destroy',$d->id)}}">
                                        <a href='{{url("/subCategory/edit/".$d->id)}}' class="btn btn-warning"><i class="fa fa-edit"></i></a>
