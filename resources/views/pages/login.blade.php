...
<head>
  ...
  <title>Login PT. molar Prima Abadi</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-8 offset-md-3 col-lg-8 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{asset('logo.png')}}" alt="logo" width="150" class="shadow-light ">
            </div>

            <div class="card card-molar">
              <div class="card-header"><h4>Login</h4></div>

              <div class="card-body">
                <form method="POST" action="{{url('try_login')}}" class="needs-validation" novalidate="">
                @csrf  
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-molar btn-lg btn-block" tabindex="4">
                      Login
                    </button>
                  </div>
                </form>
            ...
            <div class="simple-footer">
              Copyright &copy; art0fsom3th1n9 2022
            </div>
          </div>
        </div>
      </div>
