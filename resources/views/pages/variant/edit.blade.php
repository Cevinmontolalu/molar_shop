        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="row">
              ...
              <form method="post" action="{{url('variant_product/update',$data->id)}}">
                @method('put')
                  @csrf
                <div class="card">
                      ...
                      <x-alert></x-alert>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" value="{{$data->name}}" id="name" class="form-control phone-number">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="stock" value="{{$data->stock}}" id="stock" class="form-control phone-number">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="price" value="{{$data->price}}" id="price" class="form-control phone-number">
                            </div>
