                      ...
                      <x-alert></x-alert>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="categoryId" class="form-control" id="kategori" onchange="javascript:getSubKategori()">
                            ...
                            <div class="input-group">
                                ...
                                <select name="subCategoryId" class="form-control" id="subKategori">
                                    ...
                                    @foreach($subKategori as $sk)
                                        <?php $selected = "";
                                            if($sk->id==$data->subCategoryId)
                                                $selected = "selected";
                                        ?>
                                        <option {{$selected}} value="{{$sk->id}}">{{$sk->name}}</option>
                                    @endforeach
                                </select>
